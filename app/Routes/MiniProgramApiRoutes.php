...
class MiniProgramApiRoutes extends ApiRoutes
{
    ...
    public function subRoutes($router)
    {
        ...
        $router->get('/empty/activity/merchandise/{activityMerchandiseId}', ['as' => 'user.empty.activity.merchandise','uses' => 'ShoppingCartController@emptyMerchandise']);
        ...
        $router->get('/shoppingcart/activity/merchandises/{activityMerchandiseId}', ['as' => 'user.shoppingcart.activity.merchandises','uses' => 'ShoppingCartController@shoppingCartMerchandises']);
