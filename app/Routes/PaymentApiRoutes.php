...
class PaymentApiRoutes extends ApiRoutes
{
    ...
    protected function subRoutes($router)
    {
        ...
        $router->post('/ali/aggregate/payment', ['as' => 'aggregate.ali.payment.post', 'uses' => 'AliPaymentController@aggregate']);
        $router->post('/wechat/aggregate/payment', ['as' => 'aggregate.wechat.payment.post', 'uses' => 'WechatPaymentController@aggregate']);
