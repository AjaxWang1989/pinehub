...
class AppNameCommand extends Command
{
    ...
    {
        $this->currentRoot = trim(laravelToLumen($this->laravel)->getNamespace(), '\\');
    ...
    {
        $files = Finder::create()
                            ->in(laravelToLumen($this->laravel)['path'])
    ...
    {
        return laravelToLumen($this->laravel)->bootstrapPath().'/app.php';
    }
    ...
    {
        return laravelToLumen($this->laravel)['path.config'].'/'.$name.'.php';
    }
