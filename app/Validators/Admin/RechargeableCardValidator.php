...
class RechargeableCardValidator extends LaravelValidator
{
    ...
    protected $rules = [
        ValidatorInterface::RULE_CREATE => [
            ...
            'preferential_price' => 'required|integer',
            'auto_renew_price' => 'required|integer',
            'discount' => 'integer',
            ...
            'unit' => 'required|string|max:10|in:' . RechargeableCard::TIME_UNIT_DAY . ',' . RechargeableCard::TIME_UNIT_HOUR
