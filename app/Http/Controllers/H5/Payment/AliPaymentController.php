...
use App\Http\Controllers\H5\Payment\PaymentController as Controller;
...
class AliPaymentController extends Controller
{
    ...
    public function aggregate(LumenRequest $request)
    {
        ...
        $orderData = $this->preOrder($order->buildAliAggregatePaymentOrder(), $charge);
        $order->status = Order::MAKE_SURE;
        $order->save();
        return $this->response()->item( new AliPaymentSigned($orderData),
