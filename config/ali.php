...
return [
    ...
    'payment' => [
        ...
        'ali_public_key'            => storage_path(env('ALI_PAYMENT_PUBLIC_KEY_PATH', '/private/ali/rsa_public_key.pem')),

        // ！！！注意：如果是文件方式，文件中只保留字符串，不要留下 -----BEGIN RSA PRIVATE KEY----- 这种标记
        // 可以填写文件路径，或者密钥字符串  我的沙箱模式，rsa与rsa2的私钥相同，为了方便测试
        'rsa_private_key'           => storage_path(env('ALI_PAYMENT_PRIVATE_KEY_PATH', '/private/ali/rsa_private_key.pem')),
        'limit_pay'                 => [
            //'balance',// 余额
            //'moneyFund',// 余额宝
