...
return [
    ...
    'payment' => [
        ...
        // 与业务相关参数
        'notify_url'                => env('ALI_PAYMENT_NOTIFY_URL', '/ali/payment/notify/{token?}'),//webUriGenerator(env('ALI_PAYMENT_NOTIFY_URL', '/payment/ali//notify'), env('WEB_PAYMENT_PREFIX'), env('WEB_DOMAIN')),
