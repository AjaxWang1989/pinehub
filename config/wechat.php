...
return [
    ...
    'other_sdk_payment' => [
        ...
        'notify_url'        => webUriGenerator(env('WECHAT_PAYMENT_NOTIFY_URL', '/payment/wechat/notify'), env('WEB_PAYMENT_PREFIX')),
        'redirect_url'      => webUriGenerator(env('WECHAT_PAYMENT_REDIRECT_URL', '/wechat/aggregate.html'), env('WEB_PAYMENT_PREFIX')),// 如果是h5支付，可以设置该值，返回到指定页面
