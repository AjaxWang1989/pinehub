...
class CreateCards extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('cards', function (Blueprint $table) {
            $table->increments('id');
            $table->string('code', 20)->comment('卡卷编号');
            $table->string('platform', 16)->default(WX_TICKET)->comment('卡券平台类型');
            ...
            $table->unsignedTinyInteger('sync_status')->default(0)->comment('0-审核中 1-审核通过 2-审核未通过');
